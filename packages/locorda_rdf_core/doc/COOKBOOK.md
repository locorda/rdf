...
This collection of recipes shows you how to solve common RDF tasks quickly and easily with `locorda_rdf_core`.
...
While `locorda_rdf_core` doesn't include a SPARQL engine, you can implement simple query patterns:
