...
/// and tools that integrate with locorda_rdf_core.
///
/// **For implementers only** - if you're working with RDF data,
/// use `package:locorda_rdf_core/core.dart` instead.
///
/// ## Target Audience
///
...
/// - Codec implementers extending locorda_rdf_core with new formats
///
/// ## What's Included
///
...
/// import 'package:locorda_rdf_core/rdf_core_extend.dart';
///
...
///
/// This extension API may evolve more rapidly than the main locorda_rdf_core API
...
/// `locorda_rdf_core` library.
///
/// ## See Also
///
/// - Main library: `package:locorda_rdf_core/core.dart`
