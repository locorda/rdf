  ...
  void _addTripleForValue(
    ...
    if (value is String) {
      ...
      if (value.startsWith('http://') || value.startsWith('https://')) {
        // Treat as IRI
        triples.add(Quad(subject, predicate, _iriTermFactory(value)));
        ...
        if (expanded != value) {
          ...
          triples.add(Quad(subject, predicate, _iriTermFactory(expanded)));
          _log.fine(
            'Added expanded IRI triple: $subject -> $predicate -> $expanded (from $value)',
          );
        } else {
          // Wasn't expanded, treat as literal
          triples.add(Quad(subject, predicate, LiteralTerm.string(value)));
      ...
      if (value.containsKey('@id')) {
        ...
        triples.add(Quad(subject, predicate, objectTerm));
        _log.fine(
        ...
        triples.add(Quad(subject, predicate, blankNode));
        _log.fine(
