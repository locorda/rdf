...
class JsonLdContextProcessor {
  ...
  Object? _loadExternalContextDocument(
    ...
    final preloadedParsed =
        preloadedParsedContextDocuments[resolvedContextIri];
    ...
    if (value is Map<String, Object?>) {
      ...
      if (value.containsKey('@type')) {
        ...
        if (rawTypeMapping is String) {
          ...
          if (typeMapping != '@id' &&
              ...
              typeMapping != rdfJsonDatatype) {
            final expandedType =
                expandIri(typeMapping, resolutionContext);
      ...
      if (value.containsKey('@reverse')) {
        ...
        final expandedReverseIri =
            expandIri(reverseIri, resolutionContext);
      ...
      if (prefix != '_' && !key.substring(colonIndex + 1).startsWith('//')) {
        ...
        if (prefixDef != null &&
          ...
          final expandedTermIri =
              expandIri(termDef.iri!, resolutionContext);
  ...
  static final _absoluteIriPrefixPattern =
