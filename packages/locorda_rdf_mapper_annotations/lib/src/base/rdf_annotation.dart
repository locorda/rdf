...
/// `locorda_rdf_mapper_generator` package to automatically generate implementations
/// of the `locorda_rdf_mapper` interfaces. These annotations enable a declarative
