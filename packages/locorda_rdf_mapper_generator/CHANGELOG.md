...
- **Updated Dependencies**: Updated RDF-related dependencies to latest versions
  - Updated `locorda_rdf_mapper` from 0.10.1 to 0.10.2 for improved functionality
  - Updated `locorda_rdf_core` from 0.9.14 to 0.9.15 for bug fixes and enhancements
...
- **Updated Dependencies**: Updated to latest versions of RDF-related dependencies
  - Updated `locorda_rdf_mapper_annotations` to version 0.10.2 for enhanced annotation features
...
- Updated dependency versions:
  ...
  - `locorda_rdf_core` from 0.9.7 to 0.9.11
  - `locorda_rdf_mapper` from 0.9.2 to 0.9.3
  - `locorda_rdf_mapper_annotations` from 0.3.1 to 0.3.2
...
- Full support for all annotations from locorda_rdf_mapper_annotations 0.2.2:
